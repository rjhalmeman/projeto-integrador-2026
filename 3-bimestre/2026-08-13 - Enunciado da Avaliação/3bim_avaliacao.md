...
O objetivo desta avaliação é consolidar os conhecimentos em **desenvolvimento web fullstack**, na construção da arquitetura de um sistema real. Nesta etapa, o foco está no **regra de negócio principal** e na **modularização do código**.
...
### 3. 🗂️ Persistência de Dados (CRUD Completo) para todas as entidades que não sejam o núcleo do sistema. (Isso será considerado na nota do 4º Bimestre).
